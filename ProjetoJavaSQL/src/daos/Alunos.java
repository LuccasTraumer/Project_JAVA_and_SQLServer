...
public final class Alunos {
	...
	{
		if(novo == null)
			throw new Exception("Novo Valor Invalido para Inser��o!");
	...
	{
		if(alt == null)
			throw new Exception("Objeto Invalido para Altera��o!");
		if(!existe(alt.getRa()))
			throw new Exception("RA n�o Armazenado na BASE de DADOS");
		try {
			String sql;
	...
	{
		if(!existe(ra))
			throw new Exception("Codigo n�o armazenado!");
		try {
			String sql;
		...
		{
			throw new Exception("N�o foi Possivel Exclui o dado!");
		}
	}
	...
	public static String showAlunos() throws Exception // View
        ...
        public static String mediaAlunos() throws Exception // Group by
        {
            ...
            {
                throw new Exception("Não foi Possivel Verificar");
            }
